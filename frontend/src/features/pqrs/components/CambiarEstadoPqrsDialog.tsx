...
import { useCambiarEstadoPqrs } from '../hooks/usePqrs';

const OPCIONES = [
  { codigo: 'en_revision', nombre: 'En revisión' },
  { codigo: 'en_proceso',  nombre: 'En proceso' },
  { codigo: 'solucionada', nombre: 'Solucionada' },
...
export function CambiarEstadoPqrsDialog({ pqrsId, abierto, onCerrar }: Props) {
  const mutation = useCambiarEstadoPqrs(pqrsId);
  ...
  return (
    <Dialog open={abierto} onOpenChange={handleCerrar}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Cambiar estado de la PQRS</DialogTitle>
        </DialogHeader>
