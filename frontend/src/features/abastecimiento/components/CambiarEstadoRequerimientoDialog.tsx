...
import { useCambiarEstadoRequerimiento } from '../hooks/useAbastecimiento';
...
export function CambiarEstadoRequerimientoDialog({ requerimientoId, abierto, onCerrar }: Props) {
  const mutation = useCambiarEstadoRequerimiento(requerimientoId);
  ...
  return (
    <Dialog open={abierto} onOpenChange={handleCerrar}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Cambiar estado del requerimiento</DialogTitle>
        </DialogHeader>
